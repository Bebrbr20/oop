...
class Karta:
    ...
    def __str__(self):
        return str(self.barva)+ str(self.hodnota)

    def vrat_kartu(self):
        """
        Metoda vracící karty
        :return: slovnik karty
        """
        return [self.__barvy, self.__hodnota]
class Balicek:
    def __init__(self):
        self.__karty = []
        barvy = ["S", "K", "P", "L"]
...
class Krupier:
    ...
    def rozdej(selfself, balicek, pocet, hrac):
        for i in range(pocet):
